...
"""Code access: search/read + security guardrails (without Vertex)."""
...
class CodeAccessTests(SimpleTestCase):
    ...
    def test_secret_line_is_redacted(self):
        self.assertIn("redacted", C._scrub('API_KEY = "abc123"'))
        self.assertIn("redacted", C._scrub("password: hunter2"))
